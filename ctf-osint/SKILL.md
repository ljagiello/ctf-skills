...
**MCP servers (optional):** Playwright MCP ([microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp)) for browser-driven OSINT (JS-rendered pages, reverse-image/map flows) — see [browser-automation-mcp.md](browser-automation-mcp.md).
...
- [browser-automation-mcp.md](browser-automation-mcp.md) - Playwright MCP for OSINT: reading JS-rendered pages, screenshots, interactive reverse-image and map/Street View search flows, social media and Wayback snapshots, network-request mining for profile APIs
